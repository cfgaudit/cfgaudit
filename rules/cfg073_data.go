...
// bip39WordlistRaw is the official BIP-39 English wordlist (2048 words; SHA-256 of
// the upstream newline-delimited file is
// 2f5eed53a4727b4bf8880d8f3f199efc90e58503646d9ff8eff3a2ed3b24dbda).
// Source: https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt
// It is embedded as a space-joined string and split into a lookup set at init so
// CFG073 can test whether every token of a candidate phrase is a valid BIP-39 word.
const bip39WordlistRaw = `abandon ability able about above absent absorb abstract absurd abuse access accident account accuse achieve acid
...
// bip39Words is the BIP-39 wordlist as a set for O(1) membership tests.
var bip39Words = func() map[string]struct{} {
	fields := strings.Fields(bip39WordlistRaw)
