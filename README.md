...
```yaml
include:
  - component: gitlab.com/cfgaudit/cfgaudit/cfgaudit@v1.2.1
    inputs:
      path: .
      format: text
```
...
```yaml
include:
  - component: gitlab.com/cfgaudit/cfgaudit/cfgaudit-code-quality@v1.2.1
    inputs:
      path: .
```
...
|------------------|-------|
| MCP01 – Token Mismanagement & Secret Exposure | CFG021, CFG049, CFG050, CFG054, CFG058, CFG068 |
