...
```sh
gh attestation verify cfgaudit_1.12.0_linux_amd64.tar.gz -R cfgaudit/cfgaudit
```
...
```yaml
include:
  - component: gitlab.com/cfgaudit/cfgaudit/cfgaudit@v1.12.0
    inputs:
      path: .
      format: text
```
...
```yaml
include:
  - component: gitlab.com/cfgaudit/cfgaudit/cfgaudit-code-quality@v1.12.0
    inputs:
      path: .
```
